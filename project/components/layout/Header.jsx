    ...
    >
      <Container className="flex flex-col gap-1 py-8">
        ...
        <div className="mt-6 flex items-center gap-6 text-paper-muted">
          <Link href="/wishlist" onClick={onClose} className="text-sm uppercase tracking-wide inline-flex items-center min-h-[28px] -my-1">
            Wishlist
          </Link>
          <Link href="/account" onClick={onClose} className="text-sm uppercase tracking-wide inline-flex items-center min-h-[28px] -my-1">
            Account
          </Link>
        </div>
      </Container>
